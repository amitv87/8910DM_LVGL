/*
 * 杩欎釜渚嬬▼閫傜敤浜巂RTOS`杩欑被鏀寔Task鐨凱OSIX璁惧, 瀹冩紨绀轰簡鐢⊿DK閰嶇疆MQTT鍙傛暟骞跺缓绔嬭繛鎺?, 涔嬪悗鍒涘缓2涓换鍔?
 *
 * + 涓€涓换鍔＄敤浜庝繚娲婚暱杩炴帴
 * + 涓€涓换鍔＄敤浜庢帴鏀舵秷鎭?, 骞跺湪鏈夋秷鎭埌杈炬椂杩涘叆榛樿鐨勬暟鎹洖璋?, 鍦ㄨ繛鎺ョ姸鎬佸彉鍖栨椂杩涘叆浜嬩欢鍥炶皟
 *
 * 鎺ョ潃婕旂ず浜嗗湪MQTT杩炴帴涓婅繘琛屽睘鎬т笂鎶?, 浜嬩欢涓婃姤, 浠ュ強澶勭悊鏀跺埌鐨勫睘鎬ц缃?, 鏈嶅姟璋冪敤, 鍙栨秷杩欎簺浠ｇ爜娈佃惤鐨勬敞閲婂嵆鍙瀵熻繍琛屾晥鏋?
 *
 ...
 *
 * 渚嬪: [1577589489.033][LK-0317] mqtt_basic_demo&a13FN5TplKq
 *
...
/* 鎵цaiot_mqtt_process鐨勪换鍔?, 鍖呭惈蹇冭烦鍙戦€佸拰QoS1娑堟伅閲嶅彂 */
...
/* 鎵цaiot_mqtt_recv鐨勪换鍔?, 鍖呭惈缃戠粶鑷姩閲嶈繛鍜屼粠鏈嶅姟鍣ㄦ敹鍙朚QTT娑堟伅 */
...
#if 0
/* 婕旂ず浜嗚幏鍙栧睘鎬ightSwitch鐨勬湡鏈涘€?, 鐢ㄦ埛鍙皢姝ゅ嚱鏁板姞鍏ュ埌main鍑芥暟涓繍琛屾紨绀? */
...
/* 婕旂ず浜嗗垹闄ゅ睘鎬ightSwitch鐨勬湡鏈涘€?, 鐢ㄦ埛鍙皢姝ゅ嚱鏁板姞鍏ュ埌main鍑芥暟涓繍琛屾紨绀? */
...
static void ql_alisdk_data_model_task(void *arg)
{
	...
	*/
    ...
    /* 鍒涘缓涓€涓崟鐙殑浠诲姟, 涓撶敤浜庢墽琛宎iot_mqtt_process, 瀹冧細鑷姩鍙戦€佸績璺充繚娲?, 浠ュ強閲嶅彂QoS1鐨勬湭搴旂瓟鎶ユ枃 */
    ...
    /* 鍒涘缓涓€涓崟鐙殑浠诲姟鐢ㄤ簬鎵цaiot_mqtt_recv, 瀹冧細寰幆鏀跺彇鏈嶅姟鍣ㄤ笅鍙戠殑MQTT娑堟伅, 骞跺湪鏂嚎鏃惰嚜鍔ㄩ噸杩? */
    ...
    /* 涓诲惊鐜繘鍏ヤ紤鐪? */
    while (1) {
        /* TODO: 浠ヤ笅浠ｇ爜婕旂ず浜嗙畝鍗曠殑灞炴€т笂鎶ュ拰浜嬩欢涓婃姤, 鐢ㄦ埛鍙彇娑堟敞閲婅瀵熸紨绀烘晥鏋? */
