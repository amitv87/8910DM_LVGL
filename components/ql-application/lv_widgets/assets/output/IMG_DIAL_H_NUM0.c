...
#ifndef LV_ATTRIBUTE_IMG_IMG_DIAL_H_NUM0
#define LV_ATTRIBUTE_IMG_IMG_DIAL_H_NUM0
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_IMG_DIAL_H_NUM0 uint8_t IMG_DIAL_H_NUM0_map[] = {
...
const lv_img_dsc_t IMG_DIAL_H_NUM0 = {
  .header.always_zero = 0,
  .header.w = ,
  .header.h = ,
  .data_size = 0 * LV_IMG_PX_SIZE_ALPHA_BYTE,
  .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
  .data = IMG_DIAL_H_NUM0_map,
};
