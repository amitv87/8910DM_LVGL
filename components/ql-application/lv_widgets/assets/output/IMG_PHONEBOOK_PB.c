...
#ifndef LV_ATTRIBUTE_IMG_IMG_PHONEBOOK_PB
#define LV_ATTRIBUTE_IMG_IMG_PHONEBOOK_PB
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_IMG_PHONEBOOK_PB uint8_t IMG_PHONEBOOK_PB_map[] = {
...
const lv_img_dsc_t IMG_PHONEBOOK_PB = {
  .header.always_zero = 0,
  .header.w = ,
  .header.h = ,
  .data_size = 0 * LV_IMG_PX_SIZE_ALPHA_BYTE,
  .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
  .data = IMG_PHONEBOOK_PB_map,
};
